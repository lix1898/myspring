...
public class AnnotationConfigApplicationContext
{
    ...
    private List<Class> scan(Class configClass)
    {
        ...
        //从com.xiaoyao.service转换成com/xiaoyao/service
        ...
        ///C:/code_home/idea_home/mySpring/out/production/mySpring/com/xiaoyao/service
        File file = new File(resource.getFile());//得到了service目录
        File[] files = file.listFiles();
        //指定目录下的文件,不管是class,还是txt,都扫描
        //一般来说还要递归,现在简化
        //C:\code_home\idea_home\mySpring\out\production\mySpring\com\xiaoyao\service\OrderService.class
        //C:\code_home\idea_home\mySpring\out\production\mySpring\com\xiaoyao\service\UserService.class
        for (File f : files)
        {
            ...
            //传入全限定类名才行
            //com.xiaoyao.service.OrderService
            //com.xiaoyao.service.UserService
            try
            {
